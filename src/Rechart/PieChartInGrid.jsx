...
export default function PieChartInGrid() {
  return (
    <div style={{ width: "100%", minHeight: "500px" }}>
      <p>
        The <code>responsive</code> prop works well with CSS grid. The charts
        below are in a grid container. Resize the window to see how they behave.
        Each chart is a grid item.
      </p>
      <div
        style={{
          display: "grid",
